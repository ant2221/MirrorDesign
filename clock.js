...
Module.register("clock",{
	...
	getDom: function() {
		...
		var dayWrapper = document.createElement("sup");
		var periodWrapper = document.createElement("span");
		var weekWrapper = document.createElement("div")
		var labelWrapper = document.createElement("div");
		// Style Wrappers
		if (this.config.timezone) {
			dateWrapper.className = "date normal medium dimmed";
			timeWrapper.className = "time bright large light blue";
			secondsWrapper.className = "blue";
			weekWrapper.className = "week dimmed medium blue";
			dayWrapper.className = "bold"
		} else {
		...
		if(this.config.showDay) {
			dayWrapper.innerHTML = now.format(this.config.dayFormat);
		}
		if(this.config.label != null) {
		labelWrapper.innerHTML = this.config.label;
		labelWrapper.className = "bold2"; 
		}
